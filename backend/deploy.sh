...
#   gcloud secrets create meta-model-api-key --project=<PROJECT_ID>          # meetings: Meta Muse batch STT (META_MUSE_API_KEY)
...
gcloud run deploy "${SERVICE_NAME}" \
  ...
  --set-secrets="META_MUSE_API_KEY=meta-model-api-key:latest" \
