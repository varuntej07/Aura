        ...
        *,
        ...
        try:
            ...
            for turn in range(_MAX_TURNS):
                ...
                # Product-guide results deliberately have no terminal shortcut: the
                # retrieved answer is keyword-ranked and can be off-topic, so the
                # model must judge relevance and phrase the reply itself.
